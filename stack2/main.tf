...
module "bedrock_kb" {
  ...
  aurora_arn               = "arn:aws:rds:us-east-1:471452450320:cluster:my-aurora-serverless"
  aurora_db_name           = "myapp"
  aurora_endpoint          = "my-aurora-serverless.cluster-caadqfdbdcsu.us-east-1.rds.amazonaws.com"
  ...
  aurora_secret_arn        = "arn:aws:secretsmanager:us-east-1:471452450320:secret:my-aurora-serverless-11J8a7"
  s3_bucket_arn            = "arn:aws:s3:::bedrock-kb-471452450320"
}
